...
[NOTE]
--
PEM certificates are already base 64 encoded. Irrespective to this, you should still base 64 encode PEM certificates; _all certificates and PKCS#12 archives_ are expected to be base 64 encoded, to keep usage simple.
--
...
An ARM template deployment can include additional plugins.
