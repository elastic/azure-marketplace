...
the `Standard` load balancer SKU is selected, a Network Security Group will also be deployed 
and each VM in the backend pool will be assigned a public IP address, to allow outbound 
internet traffic from the VMs in the backend pool.
