...
to deploy an Elasticsearch cluster to Azure. Follwing the last step,
the UI feeds the provided parameter values to an <<arm-template, Azure Resource Manager (ARM)
